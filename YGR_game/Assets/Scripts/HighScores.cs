...
{
    //Code is built off reference code from research
    //It very likely needs to be reworked to function on unique servers
    const string privateCode = "7ho4rDNmo0eeAZJuZY00QQ2uSbAnR15kS-dqW4pdwdIQ";  //Key to Upload New Info
    const string publicCode = "65e3479a8f40bbbe88a10f72";   //Key to download
